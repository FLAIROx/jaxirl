...
sweep_configuration = {
    ...
    "parameters": {
        ...
        "irl_lrate_init": {"values": [1e-3, 1e-4]},
        "num_eval_envs": {"value": 20},
        "inner_lr_linear": {"values": [True, False]},
        "inner_lr": {"value": 4e-4},
        "inner_steps": {"value": 15},
        "discr_schedule_type": {"values": ["linear"]},
        "discr_trans_decay": {"values": [400, 600, 800, 1000]},
        "discr_final_lr": {"values": [1e-5, 1e-6]},
        "discr_updates_every": {"value": 1},
        "discr_updates": {"values": [10, 15]},
